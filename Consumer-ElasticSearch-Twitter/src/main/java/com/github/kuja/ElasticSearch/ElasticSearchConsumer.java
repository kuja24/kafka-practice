    ...
    public static void main(String[] args) throws IOException {
        ...
        while(true){
            ...
            for(ConsumerRecord<String,String> record : records){
                //2 ways to generate idempotent id
                // i) kafka generic method
                   // String id = record.topic() + record.parition() + record.offset();
                // ii) twitter data specific id
